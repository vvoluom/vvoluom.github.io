...
Those parameters are what the seller needs to input but Metamask handles the input of other unseen parameters such as seller's Ethereum address(msg.sender) and the ETH he is sending to the contract (msg.value).
